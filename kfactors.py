def kfactors (results):
    ...
    for line in range (0, len(results)):
        ...
        elif "Ca_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Ca_K)
        elif "Ca_La" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Ca_L)
        elif "Cl_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Cl_K)
        elif "Cr_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Cr_K)        
        elif "Cr_La" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Cr_L)
        elif "Cu_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Cu_K)
        elif "Cu_La" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Cu_L)
        elif "F_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_F_K)        
        elif "Fe_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Fe_K)
        elif "Fe_La" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Fe_L)
        elif "Fe_Lb3" in results[line].metadata.Sample.xray_lines:kfactors.append(0)
        elif "Fe_Ll" in results[line].metadata.Sample.xray_lines:kfactors.append(0)
        elif "Fe_Ln" in results[line].metadata.Sample.xray_lines:kfactors.append(0)
        elif "Ga_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Ga_K)             
        elif "Ga_La" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_Ga_L)
        elif "Ho_La" in results[line].metadata.Sample.xray_lines:kfactors.append(1)
        elif "La_La" in results[line].metadata.Sample.xray_lines:kfactors.append(1)
        elif "K_Ka" in results[line].metadata.Sample.xray_lines:kfactors.append(kf_K_K)
